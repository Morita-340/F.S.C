...
public class SpawnSystem : MonoBehaviour
{
    ...
    public GameObject[] Spawn(bool bossFlag){
        ...
        GameObject[] InstEnemyList = new GameObject[(int)GSetting.UniqueMagicNumber.WaveEnemyListLength];
        //生成座標のプリセットから一つを選ぶ
        for(int i = 0;i < WaveEnemyList.Count;i++){
            ...
            if(i < InstEnemyList.Length){
                InstEnemyList[i] =Instantiate(WaveEnemyList[i],InstPos * 1.2f,InstRot);
            }
